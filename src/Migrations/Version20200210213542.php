 ...
 */
final class Version20200210213542 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE payment ADD CONSTRAINT FK_6D28840D2B5CA896 FOREIGN KEY (receipt_id) REFERENCES receipt (id)');
    }
